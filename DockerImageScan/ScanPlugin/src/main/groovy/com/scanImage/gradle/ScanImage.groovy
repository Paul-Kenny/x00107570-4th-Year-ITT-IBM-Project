...
class ScanImage {
    ...
    void scanDockerImage(Project target) {
        ...
        if (inspectError.isEmpty()) {
            ...
            // Query the database for jar files and descriptions
            connection.queryDBForJar(finalJarList)
            // Query the database for CVE entries
            connection.queryDBForCVE(finalJarList)
            // Get vulnerabilities generated by database queries
            vulnerabilitiesList = connection.getVulnerabilitiesList()
